...
export const FragmentWeb = ({ data }: Props) => {
    ...
    return (
        ...
        >
            ...
            >
                <Hint text={copied ? "URL copied!" : "Sandbox URL - click to copy"} side="bottom">
                    <motion.div 
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between relative">
                            <span className="text-sm text-slate-700 truncate block font-mono flex-1 pr-2">
                                {data.sandboxurl}
                            </span>
                ...
                <div className="flex items-center gap-2">
                    <Hint text="Refresh the sandbox to reload the content" side="bottom">
                    ...
                    <Hint text="Open sandbox in a new tab" side="bottom">
                        <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.95 }}>
                            <Button 
                                variant="ghost" 
                                size="sm" 
